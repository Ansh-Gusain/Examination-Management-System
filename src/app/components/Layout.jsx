...
function Layout() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex h-screen bg-background overflow-hidden" }, sidebarOpen && /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("nav", { className: "flex-1 p-2 overflow-y-auto" }, navItems.map((item) => /* @__PURE__ */ React.createElement(
      ...
      item.path === "/replacements" && pendingReplacements > 0 && /* @__PURE__ */ React.createElement(Badge, { variant: "destructive", className: "text-[0.65rem] px-1.5 py-0" }, pendingReplacements)
    ))),
    /* @__PURE__ */ React.createElement("div", { className: "p-3 border-t border-border space-y-2" }, /* @__PURE__ */ React.createElement("div", { className: "px-3 py-1.5" }, /* @__PURE__ */ React.createElement("p", { className: "text-[0.7rem] text-muted-foreground truncate" }, "admin@gbu.ac.in")), /* @__PURE__ */ React.createElement(
      "button",
      {
