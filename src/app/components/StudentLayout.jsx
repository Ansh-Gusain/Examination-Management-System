...
function StudentLayout() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex h-screen bg-background overflow-hidden" }, sidebarOpen && /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "p-3 border-t border-border space-y-2" }, /* @__PURE__ */ React.createElement("div", { className: "px-3 py-1.5" }, /* @__PURE__ */ React.createElement("p", { className: "text-[0.75rem] font-medium truncate" }, currentStudent?.name || "Student"), /* @__PURE__ */ React.createElement("p", { className: "text-[0.65rem] text-muted-foreground truncate" }, currentStudent?.rollNumber || "\u2014", " \u2022 ", currentStudent?.branch, " \u2022 Sem ", currentStudent?.semester)), /* @__PURE__ */ React.createElement(
      "button",
      {
